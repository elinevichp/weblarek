...
const cardPreview = new CardPreview(cloneTemplate("#card-preview"), events, () => events.emit("card:click"));
...
events.on("preview:changed", () => {
    ...
    if (item.price === null) {
        ...
        cardPreview.buttonText = basket.has(item.id) ? "Удалить из корзины" : "В корзину";
